...
<!--左侧-->
  ...
  <dt class="nav_link"><a href="javascript:void(0)" class="dropdown-toggle title_nav"><i class="fa fa-bar-chart"></i><span class="menu-text"> 报表管理 </span><b class="arrow fa fa-angle-down"></b></a></dt>
    ...
    <dd class="submenu">
     <ul>
       <li class="home"><a href="../index.php?r=text/add" name="member_list.html" title="会员添加" class="iframeurl"><i class="fa fa-angle-double-right"></i>会员添加</a></li>
       <li class="home"><a href="../index.php?r=text/show" name="Columns.html" title="会员展示" class="iframeurl"><i class="fa fa-angle-double-right"></i>会员展示</a></li>
       <li class="home"><a href="../index.php?r=text/update" name="Category_Manage.html" title="会员修改" class="iframeurl"><i class="fa fa-angle-double-right"></i>会员修改</a></li>
       </ul>
      </dd>
