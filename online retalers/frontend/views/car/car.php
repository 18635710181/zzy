...
<div id="header">
    ...
    <ul>
        <li id="member_info">
                 ...
                 ?>
            <span>&nbsp;|&nbsp;</span><a href="?r=reg/reg" title="注册" rel="nofollow">注册</a></li>
        <li>&nbsp;|&nbsp;</li>
        ...
        <div class="bgf6f br10">
            ...
            <ul class="bt_1_eae bb_1_fff" id="goods_line_548546"></ul>
                <ul class="999 f13 h120 li_left" id="goods_list_548546">
                    <?php foreach ($s_car as $key =>$value):?>
                        <li class="w510 tl pl20">
                            <p>    <input type="checkbox" value="<?=$value['goods_id']?>"></p>
        ...
        <div class="w930 m0a">
            ...
            <div class="fr">
                <div class="tc cd00 mt20">
                    ...
                    <span class="f20" id="goods_amount">0.00</span>
                </div>
