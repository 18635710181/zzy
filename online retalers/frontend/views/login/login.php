...
<script src="<?=Yii::$app->params['ahead_js']?>/global.js"></script>
<style type="text/css">
<!--
...
<script type="text/javascript" src="<?=Yii::$app->params['ahead_js']?>/index.js"></script>
...
<div style="width:600px;height:450px; float:left; margin-top:30px;border:1px solid;"><img src="<?=Yii::$app->params['ahead_img']?>/gg.jpg" /></div>
...
<input type="text" value=""  id="user_name" size="35" placeholder="请输入您的账号" style="height:30px;"/>
</div>
<div style="width:495px;height:80px; float:right;" align="center";>
<span class="STYLE1">密  码</span>：<input type="password" id="password" placeholder="请输入您的密码" value=""size="35" /style="height:30px"/>
</div>
<div style="width:495px;height:80px; float:right;" align="center";>
    <a href="javascript:void (0)" id="login_submit"><img src="<?=Yii::$app->params['ahead_img']?>/denglu.png"></a>
    <a href="#"><strong> 忘记密码</strong></a>
    <br>
    <a href="?r=login/aa">微信登录</a>
</div>
...
<div class="foot">
      <div class="r1 w1225">
        <dl class=" w188">
            <dd class=" w110">
                <a href="/help-706.html" target="_blank" rel="nofollow"><img src="<?=Yii::$app->params['ahead_css']?>/images/logoxia.png"/></a>
            </dd>
        </dl>
        <dl class=" w188">
