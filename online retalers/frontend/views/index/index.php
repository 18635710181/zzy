...
<!--[if lte IE 6]>
<script src="<?=Yii::$app->params['ahead_js']?>Script/DD_belatedPNG.js"></script>
<script>
    ...
    <ul id="dropdown_nav">
			...
			<div class="sub_nav">
                <?php foreach($brand_data as $key =>$value):?>
                    <dl>
                        <dt ids="<?=$value['brand_id']?>" style="margin-bottom: 10px;"><?=$value['brand_name']?></dt>
                        <?php foreach ($value['pid'] as $k =>$v):?>
                            <a  href="?r=brand/brand&brand_id=<?=$v['brand_id']?>"><?=$v['brand_name']?></a>
                        <?php endforeach;?>
                    </dl>
                <?php endforeach;?>
				</div>
...
<div class="banner" id="banner" >
	<a href="javascript:void(0)" class="d1" style="background:url(Images/banner2.jpg) center no-repeat;"></a>
	<a href="javascript:void(0)" class="d1" style="background:url(Images/banner1.jpg) center no-repeat;"></a>
	<a href="javascript:void(0)" class="d1" style="background:url(Images/banner3.jpg) center no-repeat;"></a>
	<a href="javascript:void(0)" class="d1" style="background:url(Images/banner4.jpg) center no-repeat;"></a>
            ...
            <div class="tPdtLst">
                ...
                <ul>
                        ...
                        <a href=""   onclick="_gaq.push(['_trackEvent','首页商品','热销-男士-2','迪沃斯16155550@热销-男士-2']);">
                            <!-- <i class="c__tMsk"></i> -->
                            															<img src="<?=Yii::$app->params['ahead_img']?>/16155550_16813.jpg"  width="250" height="250" />
                        ...
                        <a href=""   onclick="_gaq.push(['_trackEvent','首页商品','热销-男士-3','赫柏林1669/07GO@热销-男士-3']);">
                            <!-- <i class="c__tMsk"></i> -->
                            															<img src="<?=Yii::$app->params['ahead_img']?>/1669_07GO_46099.jpg"  width="250" height="250" />
                        ...
                        <a href=""   onclick="_gaq.push(['_trackEvent','首页商品','热销-男士-4','格拉苏蒂·莫勒M1-37-34-LB@热销-男士-4']);">
                            <!-- <i class="c__tMsk"></i> -->
                            															<img src="<?=Yii::$app->params['ahead_img']?>/M1-37-34-LB_62213.jpg" width="250" height="250" />
                        ...
                        <a href=""   onclick="_gaq.push(['_trackEvent','首页商品','热销-男士-6','艾美达（Armand Nicolet）9740A-AG-M9740@热销-男士-6']);">
                            <!-- <i class="c__tMsk"></i> -->
                            															<img src="<?=Yii::$app->params['ahead_img']?>/9740A-AG-M9740_43172.jpg"  width="250" height="250" />
                        ...
                        <a href=""   onclick="_gaq.push(['_trackEvent','首页商品','热销-男士-7','赫柏林12443/S01@热销-男士-7']);">
                            <!-- <i class="c__tMsk"></i> -->
                            															<img src="<?=Yii::$app->params['ahead_img']?>/12443_S01_97254.jpg" width="250" height="250" />
                        ...
                        <a href=""   onclick="_gaq.push(['_trackEvent','首页商品','热销-男士-8','欧米茄212.30.41.20.03.001@热销-男士-8']);">
                            <!-- <i class="c__tMsk"></i> -->
                            															<img src="<?=Yii::$app->params['ahead_img']?>/212_30_41_20_03_001_79603.jpg"  width="250" height="250" />
                        ...
                        <a href=""   onclick="_gaq.push(['_trackEvent','首页商品','热销-男士-9','爱宝时3412.183.24.30.27@热销-男士-9']);">
                            <!-- <i class="c__tMsk"></i> -->
                            															<img src="<?=Yii::$app->params['ahead_img']?>/3196_1C_66178.jpg"  width="250" height="250" />
...
<div class="idxSet rankSet">
    ...
    <p align="center"><img src="<?=Yii::$app->params['ahead_img']?>/ban1.jpg" /></p>
...
<div class="tBdy w1225" id="hotCon">
            <div class="tPdtLst">
                ...
                <ul>
                        ...
                        <a href=""   onclick="_gaq.push(['_trackEvent','首页商品','热销-男士-5','浪琴L2.628.4.78.3@热销-男士-5']);">
                            <!-- <i class="c__tMsk"></i> -->
                                                                                        <img src="<?=Yii::$app->params['ahead_img']?>/3317_92065.jpg"  width="250" height="250" />
